...
const DailywearPage = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                setLoading(true);
                // ===== THAY ĐỔI 2: CATEGORY ID CỦA "MẶC HÀNG NGÀY" =====
                // Thay số 10 bằng ID chính xác trong database của bạn
                const dailywearCategoryID = 10;
                const data = await productService.getProductsByCategoryId(dailywearCategoryID);
    ...
    const breadcrumb = [
        { name: "Trang chủ", link: "/" },
        { name: "Mặc hàng ngày", link: "/daily-wear" },
    ];
        ...
        <div className="bg-white">
            ...
            <div className="max-w-[90%] mx-auto py-6">
                <div className="mb-4">
                    ...
                    <h2 className="text-4xl font-extrabold mt-2">MẶC HÀNG NGÀY</h2>
                </div>
