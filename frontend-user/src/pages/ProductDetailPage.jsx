          ...
          <div className="w-1/11 h-10 flex flex-col gap-2">
            {product.imageUrls.map((img, index) => (
              <img
                ...
                className={`w-full h-24 object-cover border rounded cursor-pointer hover:opacity-75 ${mainImage === img ? "border-blue-500 opacity-100" : "border-gray-300"
                  }`}
        ...
        <div className="w-full lg:w-1/2">
          ...
          <div className="mb-4">
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              {product.colors.map((color, index) => (
                <div
                  key={index}
                  className={`w-20 h-10 rounded-full border cursor-pointer p-0.5 ${selectedColor === color ? "border-blue-500 border-2" : "border-gray-300"
                    }`}
          ...
          <div className="mb-4">
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              {staticSizes.map((size, index) => (
                <button
                  key={index}
                  className={`w-20 h-10 border rounded-full text-center mr-2 text-sm font-medium ${selectedSize === size
          ...
          <div className="mt-6 relative rounded-full">
            ...
            <div className="flex gap-4">
              <button className="flex-1 flex items-center justify-center gap-2 bg-black text-white py-3 rounded-full">
                <FaShoppingCart />
                Thêm vào giỏ hàng
              </button>
            </div>
