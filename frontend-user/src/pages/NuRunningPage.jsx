...
const NuRunningPage = () => { 
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                const runningCategoryID = 7; 
                const data = await productService.getProductsByCategoryId(runningCategoryID);
    ...
    const breadcrumb = [
        { name: "Trang chủ", link: "/" },
        { name: "Nữ", link: "/nu" },
        { name: "Running Collection", link: "/running-nu" }, // Use a unique link for women's running
    ];
        ...
        <div className="bg-white">
            ...
            <div className="max-w-[90%] mx-auto py-6">
                <div className="mb-4">
                    ...
                    <h2 className="text-4xl font-extrabold mt-2">RUNNING COLLECTION</h2>
                </div>
