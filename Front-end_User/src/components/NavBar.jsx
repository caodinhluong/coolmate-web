      ...
      <div className="header bg-white border-b border-gray-200">
        <div className="container mx-auto px-2 py-2 flex justify-between items-center">
          ...
          <div className="flex space-x-4">
            ...
            <Link to="/all-product" className="mx-5 text-black-700 font-bold hover:text-black cursor-pointer">THỂ THAO</Link>
          ...
          <div className="flex items-center space-x-4">
            <div className="relative">
              ...
              <span className="absolute right-2 top-1/2 transform -translate-y-1/2">
                <FiSearch className="text-black w-7 h-7" /> {/* Replace emoji with icon */}
              </span>            </div>
              <span
            ...
            <span className="relative cursor-pointer text-2xl">
              <img src={iconCart} alt="Cart" className="w-6 h-6 mb-1"  /> {/* Thay bằng hình ảnh */}
