...
const UnderwearPage = () => { 
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                setLoading(true);
                // ===== THAY ĐỔI 2: CATEGORY ID CỦA "ĐỒ LÓT" =====
                // Thay số 9 bằng ID chính xác trong database của bạn
                const underwearCategoryID = 1; 
        ...
        <div className="bg-white">
            ...
            <div className="max-w-[90%] mx-auto py-6">
                <div className="mb-4">
                    ...
                    <h2 className="text-4xl font-extrabold mt-2">ĐỒ LÓT NAM</h2>
                </div>
