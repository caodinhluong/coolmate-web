...
const NuSportswearPage = () => { 
    ...
    const breadcrumb = [
        { name: "Trang chủ", link: "/" },
        { name: "Nữ", link: "/nu" },
        { name: "Sportswear Collection", link: "/sportswear-nu" }, // Use a unique link
    ];
        ...
        <div className="bg-white">
            ...
            <div className="max-w-[90%] mx-auto py-6">
                <div className="mb-4">
                    ...
                    <h2 className="text-4xl font-extrabold mt-2">SPORTSWEAR COLLECTION</h2>
                </div>
...
export default NuSportswearPage;