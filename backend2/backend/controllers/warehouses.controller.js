import { getAllWarehouses, getAllWarehousesWithoutPagination, getWarehousesById, createWarehouses, updateWarehouses, deleteWarehouses } from '../services/warehouses.service.js';
...
export const getAllWithoutPagination = async (req, res) => {
	try {
		const data = await getAllWarehousesWithoutPagination();
