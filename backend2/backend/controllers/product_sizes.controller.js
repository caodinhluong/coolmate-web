import { getAllProduct_sizes, getAllProduct_sizesWithoutPagination, getProduct_sizesById, createProduct_sizes, updateProduct_sizes, deleteProduct_sizes } from '../services/product_sizes.service.js';
...
export const getAllWithoutPagination = async (req, res) => {
	try {
		const data = await getAllProduct_sizesWithoutPagination();
