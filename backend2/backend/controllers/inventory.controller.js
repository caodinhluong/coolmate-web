import { getAllInventory, getAllInventoryWithoutPagination, getInventoryById, createInventory, updateInventory, deleteInventory } from '../services/inventory.service.js';
...
export const getAllWithoutPagination = async (req, res) => {
	try {
		const data = await getAllInventoryWithoutPagination();
