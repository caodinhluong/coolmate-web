import { getAllSuppliers, getAllSuppliersWithoutPagination, getSuppliersById, createSuppliers, updateSuppliers, deleteSuppliers } from '../services/suppliers.service.js';
...
export const getAllWithoutPagination = async (req, res) => {
	try {
		const data = await getAllSuppliersWithoutPagination();
