import { getAllSizes, getAllSizesWithoutPagination, getSizesById, createSizes, updateSizes, deleteSizes } from '../services/sizes.service.js';
...
export const getAllWithoutPagination = async (req, res) => {
	try {
		const data = await getAllSizesWithoutPagination();
