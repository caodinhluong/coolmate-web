...
const validationConfig = {
	...
	'product_promotions': [
		body('product_promotion_id').notEmpty().withMessage('product_promotion_id is required').isInt().withMessage('product_promotion_id must be an integer'),
		body('product_id').optional(),
		body('promotion_id').optional(),
		body('applied_discount').optional(),
	],
	'product_sizes': [
		body('product_size_id').notEmpty().withMessage('product_size_id is required').isInt().withMessage('product_size_id must be an integer'),
		body('product_id').optional(),
	...
	'sizes': [
		body('size_id').notEmpty().withMessage('size_id is required').isInt().withMessage('size_id must be an integer'),
